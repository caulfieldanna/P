        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header mod-title">
                    ...
                    <h4><span class="glyphicon glyphicon-lock"></span> Вход в личный кабиен</h4>
                </div>
...
<script src="/static/js/add_comments.js"></script>
<script src="/static/js/add_goods.js"></script>

    ...
    <div class="wrapper">
        <div class="container-fluid padding-less first-row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img class="goods img-rounded" src="/static/img/<? echo $goods_data[$key]['preview'] ?>" alt="<?php echo $goods_data[$key]['title']; ?>">
                    <div class="caption">
                        ...
                        <p><a href="/description/<?php echo''.$goods_data[$key]['id'];?>" class="btn btn-block btn-default" role="button">Подробнее</a></p>
                    </div>
                </div>
            </div>
            <?php endforeach;?>
